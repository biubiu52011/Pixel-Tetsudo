...
fpath = os.path.join(repo, \"recovery\", \"reports\", \"01_frozen_state.json\")
state = {
    \"timestamp\": datetime.now().isoformat(),
    \"head_sha\": head,
    \"branch\": branch,
    \"remote\": remote,
    \"working_tree_clean\": wt == \"\",
    \"untracked_count\": len([l for l in wt.split(chr(10)) if l.startswith(\"??\")]) if wt else 0,
    \"railway_data_json\": {
        \"path\": \"data/core/railway_data.json\",
