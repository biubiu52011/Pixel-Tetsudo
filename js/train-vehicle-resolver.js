...
var LINE_ICON_OVERRIDES = [
  ...
  var LINE_VEHICLE_OVERRIDES = {
    ...
    "Odawara": { "小田急60000系": "小田急電鉄60000形MSE",  // 千代田直通ロマンスカー（v4.3.1020）
 "2000形": "小田急電鉄2000形" },
    ...
    "Odawara": { "小田急60000系": "小田急電鉄60000形MSE",  // 千代田直通ロマンスカー（v4.3.1020）
 "2000形": "小田急電鉄2000形", "1000形": "小田急電鉄1000形", "4000形": "小田急電鉄4000形", "小田急4000形": "小田急電鉄4000形", "30000形 EXEα": "小田急電鉄30000形EXEα", "60000形 MSE": "小田急電鉄60000形MSE", "70000形 GSE": "小田急電鉄70000形GSE", "20000形": "小田急電鉄20000形", "50000形": "小田急電鉄50000形" },
    ...
    "Shinetsu":   { "211系": "211系長野色" },  // 信越本線（長野地区）211系長野色（v4.3.1020）
    ...
    "Chiyoda": { "60000系": "小田急電鉄60000形MSE", "小田急60000系": "小田急電鉄60000形MSE", "小田急4000形": "小田急電鉄4000形", "小田急1000形": "小田急電鉄1000形", "4000系": "小田急電鉄4000形", "1000系": "小田急電鉄1000形" },
    // v4.3.1015: 常磐緩行線恢复正确车型（9-21 用户明确 B 前缀=E233系2000番台；18000系为半蔵門線车，勿串）
 ...
 var MAP = {
    ...
    'TobuNikko': {
      'Local': { 'default': '東武10000系 / 東武10030系' },
      'TH-LINER': { 'default': '東武70090系(TH-LINER)' },
      'Express': { 'default': '東武10000系 / 東武10030系' },
      'SemiExpress': { 'default': '東武10000系 / 東武10030系' },
      'SectionExpress': { 'default': '東武10000系 / 東武10030系' },
      'SectionSemiExpress': { 'default': '東武10000系 / 東武10030系' },
    ...
    'Chiyoda': {
      ...
      'Local': {
        'default': '東京メトロ16000系 / 東京メトロ05系 / JR E233系',
    ...
    'Fukutoshin': {
      ...
      'Local': {
        ...
        'Tobu': '東武50070系 / 東武9000系 / 東武9050系 / 東京メトロ10000系 / 17000系',
        'Seibu': '西武40000系 / 西武6000系 / 東京メトロ10000系 / 17000系',
    ...
    'Tozai': {
      'CommuterRapid': {
        'default': '東京メトロ05系 / 東京メトロ07系 / 東京メトロ15000系 / JR E231系',
        'TokyoMetro': '東京メトロ05系 / 東京メトロ07系 / 東京メトロ15000系',
        'JR-East': 'E231系500番台 / 東京メトロ05系 / 東京メトロ07系 / 東京メトロ15000系'
      },
      'Local': {
        'default': '東京メトロ05系 / 東京メトロ07系 / 東京メトロ15000系 / JR E231系 / 東葉高速1000系',
        'TokyoMetro': '東京メトロ05系 / 東京メトロ07系 / 東京メトロ15000系',
        'JR-East': 'E231系500番台 / 東京メトロ05系 / 東京メトロ07系 / 東京メトロ15000系'
      },
      'Rapid': {
    ...
    'Yurakucho': {
      'Local': {
        'default': '東京メトロ10000系 / 17000系',
        'TokyoMetro': '東京メトロ10000系 / 17000系',
        'Tobu': '東武50070系 / 東武9000系 / 東京メトロ10000系 / 17000系',
        'Seibu': '西武40000系 / 西武6000系 / 東京メトロ10000系 / 17000系'
      },
      'Rapid': {
    ...
    'Asakusa': {
      'Local': {
        ...
        'Keikyu': '都営5300形 / 5500形 / 新1000形 / 京急1500形',
        'Keisei': '京成3000形 / 京成3700形 / 3050形 / 都営5300形 / 5500形',
        'Tobu': '都営5300形 / 5500形 / 東武8000系',
      ...
      'Rapid': {
        ...
        'Keikyu': '都営5300形 / 5500形 / 新1000形 / 京急1500形',
        'Keisei': '京成3000形 / 京成3700形 / 3050形 / 都営5300形 / 5500形',
        'KeiseiOshiage': '京成3000形 / 京成3700形 / 3050形 / 都営5300形 / 5500形',
    ...
    'TobuSkytree': {
      'Local': {
        ...
        'Toei': '東武8000系 / 都営5300形 / 5500形',
        'TokyoMetro': '東京メトロ13000系 / 東武70000系 / 20000系（日比谷線直通）',
        'Hanzomon': '東京メトロ8000系 / 08系 / 18000系 / 東武50050系',
        'Hibiya': '東京メトロ13000系 / 東武70000系 / 20000系（日比谷線直通）',
    ...
    'Tojo': {
      'Local': {
        'default': '東武50000系 / 東武50070系 / 東武30000系',
        'TokyoMetro': '東武50070系 / 東武9000系 / 東京メトロ10000系 / 17000系',
        'Minatomirai': '東武50070系',
        'Tokyu': '東武50070系 / 東急5050系 / 東急5000系',
        'Sotetsu': '東武50070系 / 東急5050系'
      },
      'SemiExpress': {
        'default': '東武50000系 / 東武30000系',
        'TokyoMetro': '東武50070系 / 東京メトロ17000系 / 東京メトロ10000系'
      },
      'Express': {
        'default': '東武50000系 / 東武50070系 / 東武30000系',
      ...
      'KawagoeLimitedExpress': {
        'default': '東武50000系 / 東武50070系（川越特急）'
      },
      'TJ-Liner': {
    ...
    'SotetsuMain': {
      'Local': {
        'default': '相鉄20000系 / 相鉄21000系 / 12000系 / 9000系 / 10000系 / 11000系 / 新7000系',
      ...
      'Rapid': {
        ...
        'JR-East': '相鉄12000系 / 相鉄新7000系 / 相鉄20000系 / 相鉄21000系',
        'Sotetsu': '相鉄20000系 / 相鉄21000系 / 12000系 / 9000系 / 11000系',
      },
      'CommuterExpress': {
    ...
    // ================================================================
    'Keikyu': {
      'Local': { 'default': '新1000形 / 1500形 / 600形', 'Toei': '都営5300形 / 5500形 / 新1000形 / 京急1500形 / 京成3000形' },
      'Express': { 'default': '新1000形 / 1500形 / 600形', 'Toei': '都営5300形 / 5500形 / 新1000形 / 京急1500形 / 京成3000形' },
      'Rapid': { 'default': '新1000形 / 1500形 / 600形', 'Toei': '都営5300形 / 5500形 / 新1000形 / 京急1500形 / 京成3000形' },
      'LimitedExpress': { 'default': '新1000形 / 1500形', 'Toei': '都営5300形 / 5500形 / 新1000形 / 京急1500形 / 京成3000形' },
      'RapidLimitedExpress': { 'default': '新1000形 / 1500形', 'Toei': '都営5300形 / 5500形 / 新1000形 / 京急1500形 / 京成3000形' },
      'AirportRapidLimitedExpress': { 'default': '新1000形', 'Toei': '都営5300形 / 5500形 / 新1000形 / 京急1500形 / 京成3000形' },
      'AccessExpress': { 'default': '新1000形', 'Toei': '都営5300形 / 5500形 / 新1000形 / 京急1500形 / 京成3000形' },
    ...
    'Kawagoe': {
      'Local': { 'default': 'E233系7000番台 / 209系3100番台 / 209系3000番台', 'Sotetsu': '相鉄12000系 / 相鉄新7000系', 'TWR': 'E233系7000番台 / 71-000形 / 70-000形' },
    ...
    'ShonanShinjuku': {
      ...
      'SpecialRapid': { 'default': 'E235系1000番台 / E231系1000番台 / E233系3000番台' },
    ...
    'Keisei': {
      'Local': {
        ...
        'Toei': '京成3000形 / 京成3700形 / 3050形 / 都営5300形 / 5500形',
    ...
    'Noda': {
      'Local': { 'default': '東武8000系 / 東武10030系 / 東武60000系 / 東武80000系' },
      'Express': { 'default': '東武8000系 / 東武10030系 / 東武60000系 / 東武80000系' },
      'SectionExpress': { 'default': '東武8000系 / 東武10030系 / 東武60000系 / 東武80000系' },
    },
    'Daishi_Tobu': {
    ...
    'Kiryu': {
      'Local': { 'default': '東武10000系 / 東武10030系' },
      'LimitedExpress': { 'default': '東武500系（リバティりょうもう）/ 東武200系（りょうもう）' },
    },
    'Koizumi': {
      'Local': { 'default': '東武10000系 / 東武10030系' },
    },
