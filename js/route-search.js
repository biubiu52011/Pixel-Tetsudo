...
(function() {
  ...
  // v4.3.962: 从 RuntimeConfig 读取（浏览器环境 RuntimeConfig 一定存在；Node 测试需先加载 runtime-config.js）
  const EXPRESS_SKIP_STATIONS = (window.RuntimeConfig && window.RuntimeConfig.EXPRESS_SKIP_STATIONS) || {};
