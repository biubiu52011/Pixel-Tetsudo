...
(function() {
    ...
    function updateOperatorNames() {
        if (typeof window.t === 'function' && typeof window.TransitConstants === 'object') {
            var _opNames = {};
            var _opIds = ['JR-East','TokyoMetro','Toei','Seibu','Tobu','Tokyu','Keio','Odakyu','Keisei','Keikyu','Sotetsu','YokohamaMunicipal','TWR','MinatoMirai','MIR','Rinkai','TsukubaExpress','Yurikamome','TamaMonorail','ShonanMonorail','ChibaUrbanMonorail','TokyoMonorail','SaitamaNewUrbanTransit'];
