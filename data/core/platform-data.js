/**
 * Pixel Tetsudo - 発着番線データ（Platform Data, v4.3.600）
 *
 ...
 *
 * 覆盖范围（v4.3.600）：首都圏 66 站/23 线（v4.3.594 首版 8 枢纽 → v4.3.597 山手線全域+中央線沿線+京浜東北
 *       → v4.3.600 中央線沿線完備（高尾まで）+京浜東北南側+常磐快速（北千住/松戸/柏）+東海道川崎+南武
