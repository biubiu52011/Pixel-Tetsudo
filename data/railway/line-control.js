...
(function() {
  ...
  window.UNIFIED_LINES = {
    "Yamanote": {
      name: "Yamanote", nameEn: "Yamanote Line", code: "JY", color: "#00B643",
    ...
    "KeihinTohoku": {
      name: "KeihinTohoku", nameEn: "Keihin-Tohoku Line", code: "JK", color: "#00B643",
    ...
    "Saikyo": {
      name: "Saikyo", nameEn: "Saikyo Line", code: "JA", color: "#00AF9F",
      operator: "JR East", region: "Tokyo Area", type: "straight",
    ...
    "Joban": {
      name: "Joban", nameEn: "Joban Rapid Line", code: "JJ", color: "#00A878",
      operator: "JR East", region: "Tokyo Area", type: "straight",
    ...
    "SobuLocal": {
      name: "SobuLocal", nameEn: "Sobu Local Line", code: "JL", color: "#00A878",
      operator: "JR East", region: "Tokyo Area", type: "straight",
    ...
    "Musashino": {
      name: "Musashino", nameEn: "Musashino Line", code: "JM", color: "#67B2E7",
      operator: "JR East", region: "Tokyo Area", type: "loop",
    ...
    "ShonanShinjuku": {
      name: "ShonanShinjuku", nameEn: "Shonan-Shinjuku Line", code: "JS", color: "#55B735",
      operator: "JR East", region: "Tokyo Area", type: "straight",
    ...
    "Takasaki": {
      name: "Takasaki", nameEn: "Takasaki Line", code: "JU", color: "#00A0C7",
    ...
    "Tsurumi": {
      name: "Tsurumi", nameEn: "Tsurumi Line", code: "JV", color: "#E04F16",
    ...
    "Nambu": {
      name: "Nambu", nameEn: "Nambu Line", code: "JN", color: "#E21B23",
      operator: "JR East", region: "Kanagawa Area", type: "straight",
    ...
    "Tokaido": {
      name: "Tokaido", nameEn: "Tokaido Line", code: "JD", color: "#00A0C7",
      operator: "JR East", region: "Tokyo Area", type: "straight",
    ...
    "JobanLocal": {
      name: "JobanLocal", nameEn: "Joban Local Line", code: "JB", color: "#86B400",
    ...
    "Yurakucho": {
      name: "Yurakucho", nameEn: "Yurakucho Line", code: "Y", color: "#A0B0B0",
      operator: "Tokyo Metro", region: "Tokyo Area", type: "straight",
    ...
    "Do-Arakawa": {
      name: "Do-Arakawa", nameEn: "Toei Arakawa Line", code: "DA", color: "#D4AF37",
      operator: "Toei", region: "Tokyo Area", type: "straight",
    ...
    "Chiyoda": { operator: "Tokyo Metro", region: "Tokyo Area", type: "straight",
    ...
    "Hanzomon": { operator: "Tokyo Metro", region: "Tokyo Area", type: "straight",
    ...
    "Namboku": { operator: "Tokyo Metro", region: "Tokyo Area", type: "straight",
      image: "../images/鉄道/東京メトロ/南北線.png", durationTotalMin: 35, throughServices: [{"line": "TokyoSakura", "code": "T", "note": "都営浅草線直通"}],
    ...
    "Fukutoshin": { operator: "Tokyo Metro", region: "Tokyo Area", type: "straight",
      image: "../images/鉄道/東京メトロ/副都心線.png", durationTotalMin: 40, throughServices: [{"line": "TokyuToyoko", "code": "TY", "note": "東急東横線直通"}],
    ...
    "Yurikamome": {
      name: "Yurikamome", nameEn: "Yurikamome", code: "U", color: "#87CEEB",
    ...
    "SeibuShinjuku": {
      name: "SeibuShinjuku", nameEn: "Seibu Shinjuku Line", code: "SN", color: "#0068B9",
    ...
    "TobuIsesaki": {
      name: "TobuIsesaki", nameEn: "Tobu Isesaki Line", code: "TI", color: "#0097A6",
    ...
    "TobuSkytree": {
      name: "TobuSkytree", nameEn: "Tobu Skytree Line", code: "TS", color: "#0097A6",
      operator: "Tobu", region: "Saitama Area", type: "straight",
    ...
    "TobuNikko": {
      name: "TobuNikko", nameEn: "Tobu Nikko Line", code: "TN", color: "#0097A6",
    ...
    "YokohamaBlue": {
      ...
      operator: "Yokohama Municipal Transportation Bureau", region: "Kanagawa Area", type: "straight",
    ...
    "SeibuIkebukuro": {
      name: "SeibuIkebukuro", nameEn: "Seibu Ikebukuro Line", code: "SI", color: "#0068B9",
      operator: "Seibu", region: "Saitama Area", type: "straight",
    ...
    "SeibuChichibu": {
      name: "SeibuChichibu", nameEn: "Seibu Chichibu Line", code: "SC", color: "#0068B9",
      operator: "Seibu", region: "Saitama Area", type: "straight",
    ...
    "SeibuTamako": {
      name: "SeibuTamako", nameEn: "Tamako Line", code: "ST", color: "#0068B9",
      operator: "Seibu", region: "Saitama Area", type: "straight",
    ...
    "SeibuTamagawa": {
      name: "SeibuTamagawa", nameEn: "Tamagawa Line", code: "SM", color: "#0068B9",
