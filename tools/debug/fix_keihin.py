...
# Replace KeihinTohoku block
old_block_marker = '"KeihinTohoku": {'
idx = content.find(old_block_marker)
if idx < 0:
    print('ERROR: KeihinTohoku not found')
    exit()
end = content.find('    },', idx) + 8
old_block = content[idx:end]

# New block with 47 stations
new_block = '''    "KeihinTohoku": {
      ...
      transferStations: [
        ...
        {"station": "川口", "connects": []},
        {"station": "赤羽", "connects": ["Utsunomiya", "Takasaki", "KeihinTohoku"]},
        {"station": "東十条", "connects": []},
        {"station": "王子", "connects": ["Nerima"]},
        ...
        {"station": "秋葉原", "connects": ["Yamanote", "Akihabara"]},
        {"station": "神田", "connects": ["Yamanote", "Marunouchi"]},
        ...
        {"station": "品川", "connects": ["Yamanote", "Yokosuka", "ShonanShinjuku"]},
        {"station": "大井町", "connects": ["Nambu"]},
        {"station": "大森", "connects": []},
        {"station": "蒲田", "connects": ["Meguro"]},
        {"station": "川崎", "connects": ["Nambu"]},
        {"station": "鶴見", "connects": ["Tsurumi", "Yokosuka"]},
        {"station": "新子安", "connects": []},
        {"station": "東神奈川", "connects": ["Yokohama"]},
        {"station": "横浜", "connects": ["Yokohama", "Blue", "TokyuToyoko"]},
...
with open(path, 'w', encoding='utf-8') as f:
    f.write(content)
print('Fixed KeihinTohoku: 47 stations, duration Array(47).fill(3)')

# Verify
jb_count = content.count('code: "JB"')
jl_count = content.count('code: "JL"')
print(f'Code check: JB={jb_count}, JL={jl_count}')
